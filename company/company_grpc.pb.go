...
const (
	...
	CompanyService_PutCompany_FullMethodName = "/crm.CompanyService/PutCompany"
)
...
type CompanyServiceClient interface {
	...
	PutCompany(ctx context.Context, in *PutCompanyRequest, opts ...grpc.CallOption) (*Company, error)
}
...
func (c *companyServiceClient) PutCompany(ctx context.Context, in *PutCompanyRequest, opts ...grpc.CallOption) (*Company, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Company)
	err := c.cc.Invoke(ctx, CompanyService_PutCompany_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CompanyServiceServer interface {
	...
	PutCompany(context.Context, *PutCompanyRequest) (*Company, error)
...
func (UnimplementedCompanyServiceServer) PutCompany(context.Context, *PutCompanyRequest) (*Company, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PutCompany not implemented")
}
...
func _CompanyService_PutCompany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PutCompanyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompanyServiceServer).PutCompany(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CompanyService_PutCompany_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompanyServiceServer).PutCompany(ctx, req.(*PutCompanyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CompanyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PutCompany",
			Handler:    _CompanyService_PutCompany_Handler,
		},
	},
